    ...
    public static void run(Estado estado) throws InterruptedException {
        ...
        while (!exit) {
            ...
            if (opcao == 1) {
                ...
                if (forn.equals("EDP")) fornecedor = new FornecEDP();
                else if (forn.equals("Endesa")) fornecedor = new FornecEndesa();
                else if (forn.equals("Jomar")) fornecedor = new FornecJomar();
                else {
                    Menu.erros(7);
                    Thread.sleep(3000);
                }
                ...
                if (dAfter.isAfter(dFornecedor)) {
                    ...
                    if (diff > 30) {
                        ...
                        if (f.equals("EDP")) forn = new FornecEDP();
                        else if (f.equals("Endesa")) forn = new FornecEndesa();
                        else if (f.equals("Jomar")) forn = new FornecJomar();
                        else {
                            Menu.erros(7);
                            Thread.sleep(3000);
                        }
